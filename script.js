...
let html = `<div class="security-card"> <div class="security-header"> <h3>Protocolo de Seguridad // Paso ${preguntaActual + 1} de ${DB_PREGUNTAS.length}</h3> </div> <p class="security-question">${data.pregunta}</p> <div class="options-grid">`;
